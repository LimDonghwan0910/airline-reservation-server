...
public class DeleteAccountRequest implements Serializable {
   ...
   */
  public DeleteAccountRequest(String userId) {
    this.userId = userId;
  }

  public DeleteAccountRequest userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userId, deleteAccountRequest.userId);
  }

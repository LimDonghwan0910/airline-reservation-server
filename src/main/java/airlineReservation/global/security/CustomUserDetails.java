...
public class CustomUserDetails implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        return List.of(new SimpleGrantedAuthority(toRoleAuthority(user.getRoleCode())));
    }
    ...
    public static String toRoleAuthority(Integer roleCode) {
        if (roleCode != null && roleCode == Const.USER_ROLE.ADMIN) {
            return "ROLE_ADMIN";
        }
        return "ROLE_MEMBER";
    }
